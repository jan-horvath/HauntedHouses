...
public class PlayerDaoImpl implements PlayerDao {
    ...
    @Override
    public Player getPlayerByGameInstance(GameInstance gameInstance) {
        try {
            return entityManager.createQuery("SELECT p FROM Player p WHERE p.gameInstance=:gi", Player.class)
                    .setParameter("gi", gameInstance)
                    .getSingleResult();
